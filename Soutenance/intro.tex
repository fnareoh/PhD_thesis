...
\begin{frame}{Example of lossless sketch: Lempel--Ziv factorization}
    ...
    \only<9->{Used for \btheme{compression} by representing $f_i=T[s..e]$ by $(d,s-e,T[e])$.}
...
\begin{frame}{}
    \centering
    \textbf{\large \bgreen{Sketch-based} \textcolor{gray}{approaches to} \borange{process} \bred{massive} \bblue{string data}}
    \medskip
    ...
    \only<3>{\includegraphics[width=0.5\textwidth]{pictures/mindmap/3.png}}
    \pause
    \pause
\end{frame}