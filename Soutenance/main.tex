...
\begin{frame}{Streaming Regular Expressions: Membership and Pattern Matching}
    ...
    \bigskip
    {
        ...
        \bblue{Membership:} Given a regexp $R$ and a text $T$, check if $T\in L(R)$.
        \bblue{Pattern matching:} Given a regexp $R$ and a text $T$, check if some substring of $T$ is in $L(R)$.
    }
