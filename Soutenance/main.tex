...
\begin{frame}{Example of a lossy compression sketch: Karp--Rabin fingerprints}
    
\end{frame}

\begin{frame}{Example of a lossless compression sketch: Lempel--ziv factorization}
