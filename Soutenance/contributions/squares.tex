...
\begin{frame}{Squares and repetition detection}
    ...
    \draw<-6> (11) node[right=4.5em] {\includegraphics[scale=0.1]{pictures/mississippi.pdf}};
    \draw<7-> (11) node[right=4.5em] {\includegraphics[scale=0.1]{pictures/square-states.pdf}};
