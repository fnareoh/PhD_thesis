...
\begin{frame}{The use of Lempel-Ziv factorization to detect squares}
    \begin{center}
        ...
        \node[hlbox, fit=(low21), myorange] {};
        \node[hlbox, fit=(low11), myorange] {};
    ...
    \begin{tikzpicture}[scale=0.9, every node/.style={transform shape}]
        ...
        \node[fit=(d23.north)(d23.south east), thick, fill=myorange!50!white, draw=black, inner sep=0pt] (rfac) {};
        ...
        \node[fit=(d13.north)(d13.south east), thick, fill=myorange!50!white, draw=black, inner sep=0pt] (rfac) {};
        }
