...
\begin{frame}{State of the art on regular expression membership}
    \begin{columns}
        ...
        \ntheme{Classic:} Recursively build the \btheme{Thompson automaton}, then check if $T$ is accepted.\\
...
\begin{frame}{Space-efficiency for regular expression}
    ...
    \medskip
    \textbf{Some intuition:} \ntheme{special cases of regexp already studied in streaming} \pause
