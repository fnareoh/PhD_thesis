...
\bred{Input:} integers ${k, \ell}$, a constant ${\eps > 0}$, strings ${S_1, S_2}$ of length ${n}$
...
The only algorithm that seemed to be practical enough is the dynamic programming one \bred{[Flouri et al.'15]}
