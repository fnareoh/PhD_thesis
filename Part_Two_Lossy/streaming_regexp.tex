...
This chapter coresponds to the following publication: \fullcite{streaming_regexp}\\
My personal contribution to this work has been the formalization of anchors and proofs of their key properties. I also participated to the overal algorithms design.
TODO: Detail (also in the intro) how it connects to the rest of the thesis and which preliminaries are helpfull.
}
\begin{small}
...
\input{Part_Two_Lossy/streaming_regex_pattern_matching/introduction}

\section{Preliminaries}
\label{sec:prelim}
\input{Part_Two_Lossy/streaming_regex_pattern_matching/preliminaries}

\section{Technical Overview}
\label{sec:overview}
\input{Part_Two_Lossy/streaming_regex_pattern_matching/overview}
...
\subsection{Anchors}
\label{sec:anchors}
\input{Part_Two_Lossy/streaming_regex_pattern_matching/anchors}

\subsection{Algorithms}
\label{sec:algorithms}
\input{Part_Two_Lossy/streaming_regex_pattern_matching/algorithms}

\section{Proof of Theorem~\ref{thm:detecting_walk_specific_weight}}
\label{sec:paths-in-graph}
\input{Part_Two_Lossy/streaming_regex_pattern_matching/paths-in-graph}
