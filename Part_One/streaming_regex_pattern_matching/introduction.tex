...
It is easy to see, however, that in the general case the time complexity of the algorithms above remains close to ``rectangular'', with some polylogarithmic factors shaved.
