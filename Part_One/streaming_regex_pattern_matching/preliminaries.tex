...
\begin{tikzpicture}
    ...
    \draw (1,0) ellipse (1.6cm and 0.8cm);
    \node at (0.9,-0.5) {$T(A)$};
    \draw (2.95,0) ellipse (1.6cm and 0.8cm);
    \node at (2.95,-0.5) {$T(B)$};
\end{tikzpicture}
\caption{$T(A\cdot B)$}
...
\begin{tikzpicture}
    ...
    \draw (2.57,1.7) ellipse (1.6cm and 0.8cm);
    \node at (2.6,1.6) {$T(A)$};
    \draw (2.57,-1.7) ellipse (1.6cm and 0.8cm);
    \node at (2.6,-1.7) {$T(B)$};
\end{tikzpicture}
...
\begin{tikzpicture}
    ...
    \node[state](f_1)[right=of i_1] {};
    \node[state,accepting](f)[right=of f_1] {$f$};
    \draw (2.85,0) ellipse (1.6cm and 0.8cm);
    \path[->] 
    (i) edge [above] node {$\eps$} (i_1)
    (f_1) edge [above] node {$\eps$} (f);
...
\begin{definition}[Partial occurrence of a regular expression]
