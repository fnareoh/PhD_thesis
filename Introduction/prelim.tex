...
The satisfiability of formulas in conjunctive normal form (a conjunction of clauses, where each clause is a disjunction of litterals) with $N$ variables\\ and $\Oh(N)$ clauses cannot be solved in time $2^{N(1-o(1))}$.}\\
