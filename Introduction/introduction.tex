...
\todo[inline]{Detail and move this section to the end, add citations about other model with mismatches + have a better transition for don't care}
...
\todo[inline]{Reformulate to incorporate the more general one or two pattern queries spaced}
...
\todo[inline]{Add indeterminate pattern matching and generalized pm}
