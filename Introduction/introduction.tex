...
However, the need for text processing goes far beyond exact matching of patterns. To illustrate this claim, we present common models of matching (underlined) with their motivations and hilight which one are studied in this manuscript. Figure~\ref{fig:intro:match_model} also provides an example for each matching model.
