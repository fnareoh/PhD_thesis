...
\begin{table}
    ...
    \begin{tabularx}{\textwidth}{T{3cm}  P{5cm}  Y}
        ...
        %
        Generalised degenerate \cite{alzamel_et_al:LIPIcs:2018:9323}  & \begin{minipage}{5cm}\centering $P=$ GATTACAT \\ \footnotesize{Some positions match a set  strings of a fixed length.} \end{minipage} &   {\renewcommand{\arraystretch}{1} AT$\left\{
            \begin{array}{l}
                \mathrm{\underline{G}}  \\
                \mathrm{T}
            \end{array}\right\}
